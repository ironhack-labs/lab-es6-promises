...
const var1 = obtainInstruction("brusselsSprouts", 0);
const var2 = obtainInstruction("brusselsSprouts", 1);
const var3 = obtainInstruction("brusselsSprouts", 2);
const var4 = obtainInstruction("brusselsSprouts", 3);
const var5 = obtainInstruction("brusselsSprouts", 4);
const var6 = obtainInstruction("brusselsSprouts", 5);
const var7 = obtainInstruction("brusselsSprouts", 6);
const var8 = obtainInstruction("brusselsSprouts", 7);


Promise.all([var1, var2, var3, var4, var5, var6, var7, var8])
    .then((values) => {
