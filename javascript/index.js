...
Promise.all([
  ...
  .then( values => document.querySelector("#brusselsSprouts").innerHTML += `<li>${values[0]}</li><li>${values[1]}</li><li>${values[2]}</li><li>${values[3]}</li><li>${values[4]}</li><li>${values[5]}</li><li>${values[6]}</li><li>${values[7]}</li>` )
