    ...
    getInstruction("mashedPotatoes", 2, (step3) => {
        ...
        getInstruction("mashedPotatoes", 3, (step4) => {
            ...
            getInstruction("mashedPotatoes", 4, (step5) => {
                ...
                potatoesImg.removeAttribute('hidden');
                })
              })
          })
      })
...
async function makeBroccoli() {
  ...
  let broccoliImgImg = document.getElementById("broccoliImg")
...
async function makebrusselsSprouts() {
  ...
  stepArr = [step0, step1, step2, step3, step4, step5, step6];
...
Promise.all()
  .then((responseArr) => {
    responseArr.forEach((element) => {responseArr[element]
