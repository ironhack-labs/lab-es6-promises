...
//     const responseUsers = response[0];
//     const responsePosts = response[1];
//     const responseAlbums = response[2];

//     console.log(`number of users... ${responseUsers.data.length}`);
//     console.log(`number of posts... ${responsePosts.data.length}`);
//     console.log(`number of albums... ${responseAlbums.data.length}`);
//   })
//   .catch((error) => {
