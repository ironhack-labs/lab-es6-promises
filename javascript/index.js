...
async function makeBroccoli() {
  try {
    ...
    document.querySelector("#broccoli").innerHTML += `<li>${step1}</li>`+= `<li>${step2}</li>`+= `<li>${step2}</li>`+= `<li>${step2}</li>`+= `<li>${step2}</li>`;
...
Promise.all([step1, step2, step3, step4, step5, step6, step7])
  .then((stepsArr) => {
    ...
    document.querySelector("#brusselsSprouts").innerHTML += `<li>The brussels Sprouts is ready!</li>`;
