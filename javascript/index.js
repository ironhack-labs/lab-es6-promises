...
//   await obtainInstruction('broccoli', 0, (step0) => {document.querySelector("#broccoli").innerHTML += `<li>${step0}</li>`});
//   await obtainInstruction('broccoli', 1, (step1) => {document.querySelector("#broccoli").innerHTML += `<li>${step1}</li>`});
//   await obtainInstruction('broccoli', 2, (step2) => {document.querySelector("#broccoli").innerHTML += `<li>${step2}</li>`});
//   await obtainInstruction('broccoli', 3, (step3) => {document.querySelector("#broccoli").innerHTML += `<li>${step3}</li>`});
//   await obtainInstruction('broccoli', 4, (step4) => {document.querySelector("#broccoli").innerHTML += `<li>${step4}</li>`});
//   await obtainInstruction('broccoli', 5, (step5) => {document.querySelector("#broccoli").innerHTML += `<li>${step5}</li>`});
// };
...
async function makeBroccoli() {
  ...
  await((step0) => {document.querySelector("#broccoli").innerHTML += `<li>${step0}</li>`});
};
