...
async function makeBroccoli() {
  try {
    ...
    response = await obtainInstruction("broccoli", 1);
    document.querySelector("#broccoli").innerHTML += `<li>${response}</li>`;

    response = await obtainInstruction("broccoli", 2);
    document.querySelector("#broccoli").innerHTML += `<li>${response}</li>`;

    response = await obtainInstruction("broccoli", 3);
    document.querySelector("#broccoli").innerHTML += `<li>${response}</li>`;

    response = await obtainInstruction("broccoli", 4);
    document.querySelector("#broccoli").innerHTML += `<li>${response}</li>`;

    response = await obtainInstruction("broccoli", 5);
    document.querySelector("#broccoli").innerHTML += `<li>${response}</li>`;
...
Promise.all([p1, p2, p3, p4, p5, p6, p7]).then((response) => {
  for (i = 0; i < 7; i++) {
