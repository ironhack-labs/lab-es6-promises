...
obtainInstruction("steak", 0)
  ...
  .then(() => {
    return obtainInstruction("steak", 2).then((step1) => {
      document.querySelector("#steak").innerHTML += `<li>${step1}</li>`;
      return obtainInstruction("steak", 1);
    });
  })
  .then(() => {
    return obtainInstruction("steak", 3).then((step2) => {
      document.querySelector("#steak").innerHTML += `<li>${step2}</li>`;
      return obtainInstruction("steak", 1);
    });
  })
  .then(() => {
    return obtainInstruction("steak", 4).then((step3) => {
      document.querySelector("#steak").innerHTML += `<li>${step3}</li>`;
      return obtainInstruction("steak", 1);
    });
  })
  .then(() => {
    return obtainInstruction("steak", 5).then((step4) => {
      document.querySelector("#steak").innerHTML += `<li>${step4}</li>`;
      return obtainInstruction("steak", 1);
    });
  })
  .then(() => {
    return obtainInstruction("steak", 6).then((step5) => {
      document.querySelector("#steak").innerHTML += `<li>${step5}</li>`;
      return obtainInstruction("steak", 1);
    });
  })
  .then(() => {
    return obtainInstruction("steak", 7).then((step6) => {
