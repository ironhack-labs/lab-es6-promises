        ...
        getInstruction(
          ...
          getInstruction(
            ...
            (step5) => {
              ...
              let mashedPotatoesImage = document.getElementById('mashedPotatoesImg');
...
obtainInstruction('steak', 0)
  ...
  .then( (step7) => {
    ...
    let stakeImage = document.getElementById('steakImg');
              stakeImage.removeAttribute("hidden");
  })
  })
  })
  })
...
async function makeBroccoli() {
  ...
  let bvoccoliImage = document.getElementById('broccoliImg');
              bvoccoliImage.removeAttribute("hidden");
}
...
Promise.all([step1,step2,step3,step4,step5,step6,step7]).then((steps) => {
for (let i=0; i<steps.length; i++) {
  document.querySelector("#brusselsSprouts").innerHTML += `<li>${steps[i]}</li>`
  document.querySelector("#brusselsSprouts").innerHTML += `<li>brussels sprouts are veady!</li>`;
  let bvussels = document.getElementById('brusselsSproutsImg');
              bvussels.removeAttribute("hidden");
}
})