    ...
    getInstruction("mashedPotatoes", 2, (step3) => {
      ...
      getInstruction("mashedPotatoes", 3, (step4) => {
        ...
        getInstruction("mashedPotatoes", 4, (step5) => {
          ...
          // const potatoeImage = document.getElementById("#mashedPotatoesImg");
          // potatoeImage.removeAttribute("hidden");
          document.querySelector("#mashedPotatoesImg").removeAttribute("hidden");
...
//     .then(obtainInstruction => resolve(obtainInstruction))
...
.then((steps) => {
  let element = document.querySelector("#brusselsSprouts")
  steps.forEach(step => {
