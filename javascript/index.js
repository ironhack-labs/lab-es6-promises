...
obtainInstruction("steak", 0)
  ...
  .catch((error) => {
    console.log("Your food is not ready");
  });
...
async function makeBroccoli() {
  try {
    ...
    let hidden = broccoliImg.removeAttribute("hidden");
    ...
    console.log("Make broccoli is done!");
  } catch (error) {
    console.log("Something went wrong: This is not broccoli");
  }
}
makeBroccoli();

let steakImg = document.getElementById("steakImg");
let hiddenSteak = steakImg.removeAttribute("hidden");

let brusselImg = document.getElementById("brusselsSproutsImg");
let hiddenBruss = brusselImg.removeAttribute("hidden");

let masImg = document.getElementById("mashedPotatoesImg");
let hiddenMas = masImg.removeAttribute("hidden");
...
Promise.all([
  ...
  .then((brusselsSprouts) => {
    console.log("values", brusselsSprouts);
