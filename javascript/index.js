      ...
      getInstruction("mashedPotatoes", 3, (step4) => {
        ...
        getInstruction("mashedPotatoes", 4, (step5) => {
         ...
         document.querySelector("#mashedPotatoesImg").removeAttribute("hidden")
          ...
          // function () {
          //   const li = `<li> Stake is ready! </li> `
          //   countriesContainer.insertAdjacentHTML("beforeend", li);
          // }
...
obtainInstruction('steak', 0)
  ...
  // .then( (step9) => {
  //   document.querySelector("#steak").innerHTML += `<li>${food} </li>`
  // })
...
.then( (resp) => {
    ...
    document.querySelector("#brusselsSprouts").innerHTML += `<li>${resp[i]}</li>`
  }
