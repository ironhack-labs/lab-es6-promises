...
obtainInstruction('steak', 0)
  .then( (step0) => {
    document.querySelector("#steak").innerHTML += `<li>${step0}</li>` //update UI
  ...
  .catch( (error) => {
    console.log("error cooking steak...", error)
  });
...
async function makeBroccoli() {
  try {
    ...
    document.querySelector("#broccoli").innerHTM += `<li>${step6}</li>`

    let step7 = document.querySelector("#broccoli").innerHTML += `<li>Enjoy</li>`
