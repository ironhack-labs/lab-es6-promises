    ...
    getInstruction("mashedPotatoes", 2, (step3) => {
      ...
      getInstruction("mashedPotatoes", 3, (step4) => {
        ...
        getInstruction("mashedPotatoes", 4, (step5) => {
          document.querySelector("#mashedPotatoes").innerHTML += `<li>${step5}</li>`;
          document.querySelector("#mashedPotatoesImg").removeAttribute("hidden");
           let isReady = document.createElement("li");
           isReady.innerText= "Mashed potatoes are ready!";
           document.querySelector("#mashedPotatoes").appendChild(isReady);
        }, (error) => console.log(error));
      }, (error) => console.log(error));
    }, (error) => console.log(error));
  }, (error) => console.log(error));
...
//let step8 = document.querySelector("#broccoli").innerHTML += `<li>Broccoli is ready! </li>`
}
