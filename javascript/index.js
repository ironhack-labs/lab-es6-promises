...
async function makeBroccoli() {
  ...
  return new Promise ((step1) => {document.querySelector('#broccoli').innerHTML += `<li>${step1}</li>`;},)
  await obtainInstruction(broccoli, 2);
  return new Promise ((step2) => {document.querySelector('#broccoli').innerHTML += `<li>${step2}</li>`;},)
  await obtainInstruction(broccoli, 3);
  return new Promise ((step3) => {document.querySelector('#broccoli').innerHTML += `<li>${step3}</li>`;},)
  await obtainInstruction(broccoli, 4);
  return new Promise ((step4) => {document.querySelector('#broccoli').innerHTML += `<li>${step4}</li>`;},)
  await obtainInstruction(broccoli, 5);
  return new Promise ((step5) => {document.querySelector('#broccoli').innerHTML += `<li>${step5}</li>`;},)
  await obtainInstruction(broccoli, 6);
  return new Promise ((step6) => {document.querySelector('#broccoli').innerHTML += `<li>${step6}</li>`;},)*/
}
  catch(err) {
    console.log(err)
  } 
