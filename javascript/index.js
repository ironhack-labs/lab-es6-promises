...
// Paso 0: Obtenemos la primera instrucción para preparar puré de patatas.
// Luego, añadimos el paso 0 al elemento con ID "mashedPotatoes" como un elemento de lista.
getInstruction(
  "mashedPotatoes",
  0,
  (step0) => {
    ...
    getInstruction(
      "mashedPotatoes",
      1,
      (step1) => { // Paso 1: Obtenemos la siguiente instrucción y la agregamos como un elemento de lista.
        document.querySelector("#mashedPotatoes").innerHTML += `<li>${step1}</li>`;
...
// ...
const steps = obtainInstruction("steak", 0)
.then((step0) => {
