...
obtainInstruction("steak", 0)
  ...
  .then((step7) => {
    document.querySelector("#steak").innerHTML += `<li>Steak is read</li>`;
...
// Bonus 2 - Promise all
const promise1 = obtainInstruction("mashedPotatoes", 0);
const promise2 = obtainInstruction("steak", 0);
const promise3 = obtainInstruction("brusselsSprouts", 0);
const promise4 = obtainInstruction("broccoli", 0);
...
Promise.all([promise1, promise2, promise3, promise4])
  .then((values) => {
    ...
    values.forEach((instruction) => {
      ...
      steakList.innerHTML += `<li>${instruction}</li>`;
      brusselsSproutsList.innerHTML += `<li>${instruction}</li>`;
      broccoliList.innerHTML += `<li>${instruction}</li>`;
    });
  })
  .catch((err) => {
