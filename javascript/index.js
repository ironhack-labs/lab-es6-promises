...
// Comment: since there is no "then / catch", the function will run in no particular order,
// and therefore will display instruction in the wrong order. 
// let's implement them to see the instructions being display in the right order.
