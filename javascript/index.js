...
const broc1 = obtainInstruction('broccoli', 0)

const broc2 = obtainInstruction('broccoli', 1)

const broc3 = obtainInstruction('broccoli', 2)

const broc4 = obtainInstruction('broccoli', 3)

const broc5 = obtainInstruction('broccoli', 4)

const broc6 = obtainInstruction('broccoli', 5)

const broc7 = obtainInstruction('broccoli', 6)

const broc8 = obtainInstruction('broccoli', 7)
...
async function makeBroccoli() {
  try{
    ...
    let step8 = await obtainInstruction('broccoli', 8);
