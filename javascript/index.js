...
Promise.all ([
 ...
 .then((steps) => steps.forEach((step) => document.querySelector("#brusselsSprouts").innerHTML += `<li>${step}</li>`))
 .then(() => document.querySelector("#brusselsSprouts").innerHTML += `<li>brusselsSprouts is ready</li>`)
