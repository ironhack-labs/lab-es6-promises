...
//   setTimeout(() => resolve("#brusselsSprouts"), 0);
// });

// const step1 = new Promise((resolve, reject) => {
//   setTimeout(() => resolve("#brusselsSprouts"), 1);
// });

// const step2 = new Promise((resolve, reject) => {
//   setTimeout(() => resolve("#brusselsSprouts"), 2);
// });


// Promise.all( [step0, step1, step2] )
//   .then((step) => document.querySelector("#brusselsSprouts").innerHTML += `<li>${step}</li>`;
