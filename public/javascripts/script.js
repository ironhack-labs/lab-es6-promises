...
makeFood().then();
//makeFood(brusselSprouts[0], 'brusselSprouts');
// makeFood(brusselSprouts[2], 'brusselSprouts');
// makeFood(brusselSprouts[3], 'brusselSprouts');
// makeFood(brusselSprouts[4], 'brusselSprouts');
